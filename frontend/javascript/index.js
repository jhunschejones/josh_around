...
if (document.querySelector(".js-youtube-button")) {
  document.querySelector(".js-youtube-button")
    .addEventListener("click", () => window.open("https://www.youtube.com/@josh_around/videos", "_blank"));
}
